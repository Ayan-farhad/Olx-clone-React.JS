function Footer() {
    return (<footer>
        ...
        <div style={{ background: 'bisque', display: 'flex' }} >
            <img src="https://www.olx.com.pk/assets/olxMobileApp.f5579f77e849b600ad60857e46165516.webp" ></img>
            ...
            <div style={{width:'30%', marginTop:'2rem' , marginLeft:'2rem'}}>
                ...
                <img style={{ width: '25%', marginLeft: '4rem' }} src="https://www.olx.com.pk/assets/iconAppStoreEN_noinline.a731d99c8218d6faa0e83a6d038d08e8.svg" ></img>
                <img style={{ width: '25%' }} src="https://www.olx.com.pk/assets/iconGooglePlayEN_noinline.9892833785b26dd5896b7c70b089f684.svg" ></img>
                <img style={{ width: '25%' , marginRight:'2rem'  }} src="https://www.olx.com.pk/assets/iconAppGallery_noinline.6092a9d739c77147c884f1f7ab3f1771.svg" ></img>
            </div>
        </div>
