...
function Cards({ price, description, images, title , id }) {
    const navigate = useNavigate()
    return (
                <div style={{ display: "inline-flex", marginBottom: 20, margin: 10 }}  >
            <div onClick={()=>navigate(`DetailScreen/${id}`)}  style={{ borderRadius: 5, height: 400, border: '1px solid rgb(199, 196, 196)' }} className="color">
